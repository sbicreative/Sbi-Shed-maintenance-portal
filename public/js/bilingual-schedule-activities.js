(function attachBilingualScheduleActivities(globalObject) {
    ...
    const verifiedTranslations = new Map([
        ...
        ,["INSPECTION WING ELECTRICAL: CHECK AND RECORD FOLLOWINGS", "विद्युत निरीक्षण विंग: निम्न बिंदुओं की जाँच करके दर्ज करें।"]
        ,["(Flasher lights are working in main & standby.)", "फ्लैशर लाइट की मुख्य और स्टैंडबाय स्थिति में कार्यशीलता जाँचें।"]
        ,["FDU unit set voltage at test point", "FDU यूनिट का वोल्टेज टेस्ट पॉइंट पर सेट करें।"]
        ,["Function test :", "कार्यशीलता परीक्षण:"]
        ,["Take the traction both in forward & reverse direction and ensure 596 nodes appear on screen.", "ट्रैक्शन को आगे और पीछे दोनों दिशाओं में चलाकर स्क्रीन पर 596 नोड दिखाई देना सुनिश्चित करें।"]
        ,["While Loco is energised, check the following:", "लोको ऊर्जित होने पर निम्न बिंदुओं की जाँच करें:"]
        ,["While Loco is energised, Check and attend for proper working of", "लोको ऊर्जित होने पर निम्न उपकरणों की सही कार्यशीलता जाँचें और आवश्यक कार्रवाई करें।"]
        ,["CVVRS: Check proper function and setting of all cameras. Ensure date and time also.", "CVVRS: सभी कैमरों की सही कार्यशीलता और सेटिंग जाँचें। दिनांक और समय भी सही होना सुनिश्चित करें।"]
        ,["Vigilance working from both cabs", "दोनों कैब से विजिलेंस की कार्यशीलता जाँचें।"]
        ,["160 kept on 0 ensure speed showing 14 kmph", "160 को 0 पर रखने पर गति 14 kmph दिखाई देना सुनिश्चित करें।"]
        ,["FB Cubical contactor air leakage ( 8.1 &8.2 )", "FB क्यूबिकल कॉन्टैक्टर 8.1 और 8.2 में वायु रिसाव जाँचें।"]
        ,["VCD becomes active when any one or more operation listed below is not performed for continuous 60 seconds (1 minute)", "नीचे दी गई एक या अधिक क्रियाएँ लगातार 60 सेकंड (1 मिनट) तक न करने पर VCD सक्रिय होना सुनिश्चित करें।"]
        ,["iii) Sander operation", "iii) सैंडर की कार्यशीलता जाँचें।"]
        ,["Items to Check", "जाँच किए जाने वाले बिंदु"]
        ,["Items to check", "जाँच किए जाने वाले बिंदु"]
        ,["Energize the loco and check for abnormal sound of any auxiliary machine.", "लोको को ऊर्जित करके किसी भी सहायक मशीन से असामान्य आवाज की जाँच करें।"]
        ,["CHEK THE WORKING OF FOLLOWING ITEMS :", "निम्न उपकरणों की कार्यशीलता जाँचें:"]
        ,["Both side IVF coupler contact pin to be checked for RUSTING/FLASHING & free movement of pin/spring by pressing it. If required, replace the same.", "दोनों ओर IVF कपलर के कॉन्टैक्ट पिन में जंग/फ्लैशिंग तथा पिन/स्प्रिंग की स्वतंत्र गति दबाकर जाँचें। आवश्यकता होने पर बदलें।"]
        ,["Following check points are to be added in existing TI Performa of WAP5 locos", "WAP5 लोको के मौजूदा TI प्रपत्र में निम्न जाँच बिंदु शामिल करें।"]
        ,["Power cable connection for any overheating physical damage or discoloration. Check for loose connections and ensure that all parts are in good condition", "पावर केबल कनेक्शन में अधिक गर्मी, भौतिक क्षति या रंग बदलने की जाँच करें। ढीले कनेक्शन जाँचें और सभी भाग अच्छी स्थिति में होना सुनिश्चित करें।"]
        ,["Assembly gap. Check with “NO GO Gauge”.", "असेंबली गैप को ‘NO GO Gauge’ से जाँचें।"]
        ,["Inspection Wing Mechanical: Check and record Following", "यांत्रिक निरीक्षण विंग: निम्न बिंदुओं की जाँच करके दर्ज करें।"]
        ,["Operation time Approx.", "अनुमानित कार्य समय दर्ज करें।"]
        ,["Duplex check valve setting/Brake Pipe Pressure by", "डुप्लेक्स चेक वाल्व सेटिंग/ब्रेक पाइप दबाव जाँचें।"]
        ,["Working, Tower to change every minute (FTIL, SIL) & In every two minutes (KBIL)", "कार्यशीलता जाँचें: FTIL/SIL में टावर प्रत्येक मिनट तथा KBIL में प्रत्येक दो मिनट में बदलना चाहिए।"]
        ,["Wiper Operation", "वाइपर की कार्यशीलता जाँचें।"]
        ,["Sander Operation", "सैंडर की कार्यशीलता जाँचें।"]
        ,["(A) Pneumatic System (When Loco is energised check, attend and record)", "(A) न्यूमैटिक प्रणाली: लोको ऊर्जित होने पर जाँचें, आवश्यक कार्रवाई करें और दर्ज करें।"]
        ,["MR: (i) Mainline MR leakage without application of SA-9 Direct Brake", "MR: (i) SA-9 डायरेक्ट ब्रेक लगाए बिना मेनलाइन MR रिसाव जाँचें।"]
        ,["(ii) Mainline MR leakage with application of SA-9 Direct Brake", "(ii) SA-9 डायरेक्ट ब्रेक लगाकर मेनलाइन MR रिसाव जाँचें।"]
        ,["(RS drop) Panto line air leakage 0.70 kg/cm2 in 5 minutes.", "(RS ड्रॉप) पेंटो लाइन में वायु रिसाव 5 मिनट में अधिकतम 0.70 kg/cm² होना जाँचें।"]
        ,["B- Check and Record Vertical & lateral clearance (Primary & Secondary) as per TC/0082 (REV-1) dated 17/09/2015", "B- TC/0082 (REV-1), दिनांक 17/09/2015 के अनुसार ऊर्ध्वाधर और पार्श्व क्लीयरेंस (प्राइमरी एवं सेकेंडरी) जाँचकर दर्ज करें।"]
        ,["C- Check and record wheel gauge below Parameters: (IC Schedule) WHEEL GAUGE [Permissible limit 1596+3-0.5 mm, (1596±0.5 mm for RB/New loco)]", "C- IC शिड्यूल में दिए गए मानकों के अनुसार व्हील गेज जाँचकर दर्ज करें [स्वीकार्य सीमा 1596+3-0.5 mm; RB/नए लोको के लिए 1596±0.5 mm]।"]
        ,["E- Measure D SHAKLE and write Coupling No.", "E- D SHACKLE मापें और कपलिंग संख्या दर्ज करें।"]
        ,["v) Baby compressor/CPA safety valve (8.5 kg/cm2) to be replace by overhauled", "v) बेबी कंप्रेसर/CPA सेफ्टी वाल्व (8.5 kg/cm²) को ओवरहॉल किए हुए वाल्व से बदलें।"]
        ,["No air leakage", "वायु रिसाव नहीं होना सुनिश्चित करें।"]
        ,["7Kg Load Test", "7 किग्रा लोड परीक्षण करें।"]
    ]);
